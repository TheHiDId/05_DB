...
VALUES('MEM04', 'QQQQ2222', '신짱구', '960202-1876543');
...
CREATE TABLE USER_USED_NN(
    USER_NO NUMBER CONSTRAINT USER_NO_NN NOT NULL, -- 제약조건명 미지정 시 "SYS~" 형태로 자동 지정  
    USER_ID VARCHAR2(20),
...
CREATE TABLE USER_USED_UK(
    USER_NO NUMBER,
--    USER_ID VARCHAR2(20) CONSTRAINT USER_ID_U UNIQUE, -- 컬럼 레벨 설정
    USER_ID VARCHAR2(20),
    USER_PWD VARCHAR2(30),
    USER_NAME VARCHAR2(30),
    GENDER VARCHAR2(10),
...
-- NOT NULL + UNIQUE 특징이 더해진 제약조건의 의미
-- 한 테이블당 한 개의 제약조건만 설정할 수 있음
